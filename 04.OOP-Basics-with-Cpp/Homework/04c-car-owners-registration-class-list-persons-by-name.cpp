...
Task 4c - A bonus task :)
 List all persons which names start with a specific letter without iterating all of them. */
...
int main()
{
    while (true)
    {
        ...
        cout << "------------------------------" << endl
            ...
            << "18- Persons statistics by start name letter" << endl << endl
